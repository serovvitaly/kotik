...
--
-- Dumping data for table `template_purchases`
--

LOCK TABLES `template_purchases` WRITE;
/*!40000 ALTER TABLE `template_purchases` DISABLE KEYS */;
/*!40000 ALTER TABLE `template_purchases` ENABLE KEYS */;
UNLOCK TABLES;
