...
--
-- Dumping data for table `pricing_columns`
--

LOCK TABLES `pricing_columns` WRITE;
/*!40000 ALTER TABLE `pricing_columns` DISABLE KEYS */;
/*!40000 ALTER TABLE `pricing_columns` ENABLE KEYS */;
UNLOCK TABLES;
